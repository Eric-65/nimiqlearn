 ...
 * "✨ AI assessment — Generated by NimiqLearn AI" — never a specific provider/model name.
 */
export default function ExplanationResult({ evaluation, beforeMastery = 0, afterMastery, statusAfter }) {
  const { t } = useI18n();
    ...
    <div className="anim-pop" aria-live="polite">
      ...
      <div className="flex items-center justify-between wrap gap-8" style={{ marginBottom: 14 }}>
        ...
        <span className="tiny muted">
          {t(modelGenerated ? "result.byAI" : "result.byFallback")}
        </span>
      </div>
      ...
      <Card style={{ marginBottom: 18 }}>
        <div className="flex items-center justify-between wrap gap-16">
          <div>
            <p className="small strong" style={{ margin: "0 0 4px", color: "var(--c-text-dim)" }}>{t("result.understanding")}</p>
