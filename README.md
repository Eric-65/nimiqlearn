...
| `server/` | A small Express backend holding two AI provider secrets server-side: `HF_TOKEN` for the live **ExplainBack AI Tutor** (GLM-5.3, via Hugging Face), and `ANTHROPIC_API_KEY` for Claude — built but not wired into any page yet. Never bundled into the app — see `nimiqlearn-ai-educational-app/docs/explainback-ai-tutor.md` and `docs/learn-concept.md`. | `npm install && npm start` |
...
- `nimiqlearn-ai-educational-app/docs/explainback-ai-tutor.md` — the live GLM-5.3 ExplainBack AI Tutor: architecture, configuration, honesty model
