...
| `server/` | A small Express backend that holds `ANTHROPIC_API_KEY` server-side for Claude-powered teaching. Not wired into any page yet — kept as plumbing for a planned Claude "AI Tutor" inside ExplainBack. Never bundled into the app — see `nimiqlearn-ai-educational-app/docs/learn-concept.md`. | `npm install && npm start` |
...
- `nimiqlearn-ai-educational-app/docs/learn-concept.md` — the Claude teaching backend architecture, honesty model, and the planned ExplainBack "AI Tutor" direction
